    ...
    for name, url in URLS.items():
        try:
            ...
            if name == "LUN_Kharkiv":
                ...
                # Шукаємо першу картку оголошення на АН Город
            ...
            if link and link != last_ids.get(name):
                labels = {"LUN_Kharkiv": "🏙 ЛУН", "REM_Kharkiv": "🏠 REM.ua", "AN_Gorod": "🏢 АН Город"}
                msg = f"{labels.get(name, name)}: Знайдено новий варіант!\n\n🔗 {link}"
